const committeesData = [
    ...
    { name: "UNODC", full: "United Nations Office on Drugs & Crime", logo: "assets/UNODC.png", agenda: "Assessing Drug Policy Frameworks and Their Impact on Public Health, Human Rights", eb: [{ name: "Navam Endlay", role: "Chairperson", img: "assets/MUNchair26/NavamEndlay_Chairperson_UNODC.JPG"},{ name: "Viswaram", role: "Vice Chairperson", img: "assets/MUNchair26/VISWARAM-VICECHAIRPERSON-UNODC.jpg"}] },
    { name: "ECOSOC", full: "Economic & Social Committee", logo: "assets/ECOSOC.png", agenda: "Post-2030 Development Agenda", eb: [{ name: "Chairperson", role: "TBA", img: "https://placehold.co/100x100/6b3bc9/white?text=ECOSOC"},{ name: "Grhitha Sahu", role: "Vice Chair", img: "assets/MUNchair26/Grhitha Sahu_Vice Chair_ECOSOC.jpeg"}] },
...
const featuredData =[
    ...
    { name: "OAS", full: "Organization of American States", logo: "assets/OAS.png", agenda: "Twentieth Meeting of Consultation · Freeze: April 26, 1982", eb: [{ name: "Sai Smrithi", role: "Vice Chairperson", img: "assets/MUNchair26/Sai smrithi - vice chairperson- OAS.jpg"},{ name: "Praghathi Suresh", role: "Moderator", img: "assets/MUNchair26/Praghathi Suresh_Moderator_OAS.jpeg"}] }
];
